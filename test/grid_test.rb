...
class TestGrid < Minitest::Test
  ...
  def test_small_ships_are_only_2_cells
    empty_grid = Grid.new
    grid = empty_grid.populate_grid
    assert_output("You tried placing a small ship that is greater than two cells long, or would wrap around the grid! The coordinates must correspond to the first and last cells of the ship. Please re-enter the squares for the ship.\n") do
  ...
  def test_large_ships_are_only_3_cells
    empty_grid = Grid.new
    grid = empty_grid.populate_grid
    assert_output("You tried placing a large ship that is greater than three cells long, or would wrap around the grid! The coordinates must correspond to the first and last cells of the ship. Please re-enter the squares for the ship.\n") do
  ...
  def test_no_diagonal_ships
    ...
    assert_output("You tried placing a ship diagonally! Your ship can only be horizontal or vertical. Please re-enter the squares for the ship.\n") {
  ...
  def test_no_overlapping_ships
    ...
    assert_output("You tried placing a ship that would overlap over another ship! Please re-enter the squares for the ship.\n") {
